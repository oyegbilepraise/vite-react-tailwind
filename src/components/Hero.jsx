const Hero = () => {
  return (
    <>
      <div className="flex items-center justify-center text-center flex-col mx-auto" style={{ maxWidth: '500px', marginTop: '50px' }}>
        <img src="/images/illustration-intro.png" alt="" style={{ width: '500px' }} />
        <div className="text-white mt-5 px-5">
          <p className="text-2xl">All your files in one secure location, accessible anywhere.</p>
          <p className="text-xs mt-4 text-gray-400">Fylo stores all vour most important files in one secure location lem wherever you need, share and undends famiy. and co-workers. Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam, dolorum lorem lorem.</p>
          <button className="text-center text-white rounded-full py-2 px-14 mt-4 button">Get Started</button>
        </div>
      </div>
      <div className="flex items-center justify-center text-center flex-col mx-auto mt" style={{ maxWidth: '600px' }}>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-20 text-white items-center justify-center">
          <div className="">
            <svg className="flex items-center justify-center mx-auto" width="83" height="78" xmlns="http://www.w3.org/2000/svg">
